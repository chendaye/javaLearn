...
class Thread_3 extends Thread{
    ...
    public void run(){
        ...
        for (int i=0; i<100; i++){
            //todo:线程都有自己的名称 Thread.currentThread()取当前运行线程
...
class useThread{
    public static void main(String[] args) {
        ...
        new Thread(){
            public void run(){
                for (int i=0; i<1000; i++){
                    System.out.println("two Thread"+Thread.currentThread().getName()+"..."+i);
                }
            }
        }.start();
        //todo:线程 2
        Runnable run = new Runnable(){
            public void run(){
                for (int i=0; i<1000; i++){
                    System.out.println("three Thread"+Thread.currentThread().getName()+"..."+i);
                }
            }
        };
        ...
        //todo:线程 3
        for (int i=0; i<1000; i++){
            System.out.println("one Thread"+Thread.currentThread().getName()+"..."+i);
        }
    }
}