package Algorithm.Interview.Basic.CusClassLoader;
...
public class CusClassLoader extends ClassLoader {
    ...
    public Class findClass(String name){
        ...
        //todo: Class reflect = Class.forName("Algorithm.Interview.Basic.Reflect.Person"); 反射也是返回的 Class 对象
...
//        path = "E:\\learnJava\\src\\Algorithm\\Algorithm.Interview\\Basic\\Class\\Test.class";
        InputStream in = null;
