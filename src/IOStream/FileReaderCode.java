...
//        copyFileDemo();
    ...
    public static void readDemo() throws IOException{
        FileReader fileReader = new FileReader("E:\\learnJava\\src\\IOStream\\IOExceptionCode.java");
    ...
    public static void copyFileDemo() throws IOException{
        //读取的文件
        FileReader fr = new FileReader("E:\\learnJava\\src\\IOStream\\IOExceptionCode.java");
        // 写入的文件
    ...
    public static void copyFileDemo2(){
        ...
        try {
            //读取的文件
            fr = new FileReader("E:\\learnJava\\src\\IOStream\\IOExceptionCode.java");
            // 写入的文件
